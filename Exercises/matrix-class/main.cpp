...
int main() {
    std::vector< std::vector<float> > m1 (5, std::vector<float>(3, 4));
    Matrix matrix_1 = Matrix(m1);
    ...
    std::cout << "Rows " << matrixa.getCols() << std::endl;
    ...
    Matrix new_matrix(matrixa.matrix_addition(matrixb));
